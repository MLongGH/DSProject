...
$(document).ready(function() {
    ...
    $("#submit").click(function () {
        ...
        if (file == null) {
            ...
            if (file.name == "audioFile1.rtf") {
                if ($("#check1").prop("checked") && $("#check2").prop("checked")) {
                    $("#showResult").text("This is the result for gender and accent for file:audioFile1!");
                } else if ($("#check1").prop("checked") && $("#check2").prop("checked") == false) {
                    $("#showResult").text("This is the result for gender for file:audioFile1!");
                } else if ($("#check1").prop("checked") == false && $("#check2").prop("checked")) {
                    $("#showResult").text("This is the result for accent for file:audioFile1!");
                } else {
